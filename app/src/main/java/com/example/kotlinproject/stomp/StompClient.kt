package com.example.kotlinproject.stomp

import com.example.kotlinproject.stomp.constants.Codes
import com.example.kotlinproject.stomp.constants.Commands
import com.example.kotlinproject.stomp.constants.Headers
...
class StompClient(private val okHttpClient: OkHttpClient,
    ...
    private lateinit var emitter: ObservableEmitter<Event>
     ...
     var url: String = "ws://[domain]/connect/websocket"
